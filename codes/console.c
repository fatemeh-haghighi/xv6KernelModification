...
#define KEY_UP 0xE2
#define KEY_DN 0xE3
#define KEY_LF 0xE4 //not used
#define KEY_RT 0xE5 //not used
#define UPCODE 226 //not used
#define DOWNCODE 227 //not used
#define MAX_HISTORY_LENGTH 5
char History[MAX_HISTORY_LENGTH][INPUT_BUF];
int HistoryPos = 0;
int MaxHistoryPos = 0;
int HistoryWrite = 0;
int NextHistoryPos = 0;
...
consoleintr(int (*getc)(void))
{
  ...
  while((c = getc()) >= 0){
    ...
    case C('H'): case '\x7f':  // Backspace
      ...
      //////////////////////////////////////////////////////////////////////start
    case KEY_UP:
      NextHistoryPos = (HistoryPos + MAX_HISTORY_LENGTH - 1) % MAX_HISTORY_LENGTH;
